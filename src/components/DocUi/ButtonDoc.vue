...
<script lang="ts">
import ButtonDemo1 from '../../demo-code/DomeButton/ButtonDemo1.vue'
import ButtonDemo2 from '../../demo-code/DomeButton/ButtonDemo2.vue'
import ButtonDemo3 from '../../demo-code/DomeButton/ButtonDemo3.vue'
